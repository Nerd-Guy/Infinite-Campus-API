...
class Student:
    ...
    def start_session(self) -> None:
        ...
        self.data = dist_response_json["data"][0]
        self.dist_id = self.data["id"]
        self.district_name = self.data["district_name"]
        self.district_baseurl = self.data["district_baseurl"]
        self.district_app_name = self.data["district_app_name"]
